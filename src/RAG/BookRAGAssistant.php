...
class BookRAGAssistant
{
     ...
     * 执行预定义操作
     */
    public function executeAction(string $actionName, int $topK = DEFAULT_TOP_K, string $language = 'Chinese'): string
    {
    ...
    public function showRetrievedChunks(string $question, int $topK = DEFAULT_TOP_K): void
    {
        $queryEmbedding = $this->embedder->embedQuery($question);
